...
export const AUTHENTICATION_ENDPOINT = `${AUTH}?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI.production}&scope=${SCOPES_URL_PARAM}&response_type=token&show_dialog=true`;
