...
export const AUTHENTICATION_ENDPOINT = `${AUTH}?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI.dev}&scope=${SCOPES_URL_PARAM}&response_type=token&show_dialog=true`;
...
export const GET_USER_TOP_ARTIST = `${SPOTIFY_API}me/top/artist`;
